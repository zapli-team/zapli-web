...
export default async function ArticlePage({ params }: Props) {
    ...
    return (
        <div className="min-h-screen">
            <article className="mx-auto max-w-6xl px-6 py-16 pt-28 md:px-10 md:py-32 md:pt-36">
                <Link
                    href="/news"
                ...
                <div
                    className="article-body prose font-rubik prose-headings:font-ploni max-w-none leading-relaxed"
